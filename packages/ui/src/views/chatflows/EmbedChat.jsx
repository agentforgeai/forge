...
const embedPopupHtmlCode = (chatflowid) => {
    ...
    import Chatbot from "https://cdn.jsdelivr.net/npm/AgentForge-embed/dist/web.js"
    Chatbot.init({
...
const embedPopupReactCode = (chatflowid) => {
    return `import { BubbleChat } from 'AgentForge-embed-react'
...
const embedFullpageHtmlCode = (chatflowid) => {
    return `<AgentForge-fullchatbot></AgentForge-fullchatbot>
<script type="module">
    import Chatbot from "https://cdn.jsdelivr.net/npm/AgentForge-embed/dist/web.js"
    Chatbot.initFull({
        chatflowid: "${chatflowid}",
...
const embedFullpageReactCode = (chatflowid) => {
    return `import { FullPageChat } from "AgentForge-embed-react"
                            ...
                            <span>
                                ...
                                <p>
                                    ...
                                    <a
                                        rel='noreferrer'
                                        target='_blank'
                                        href='https://www.npmjs.com/package/AgentForge-embed?activeTab=versions'
                                    >
                                        version
                                    </a>
                                    :&nbsp;<code>{`https://cdn.jsdelivr.net/npm/AgentForge-embed@<version>/dist/web.js`}</code>
                                </p>
                            </span>
