...
import WalletConnection from '@/ui-component/wallet/WalletConnectioncopy'
// ===========================|| CANVAS NODE ||=========================== //
                ...
                >
                    <Box>
                        ...
                        {data.outputAnchors.length > 0 &&
                            data.name != 'Brain' &&
                            (data.name == 'TwitterAccess' ||
                                data.name == 'DiscordAccess' ||
                                data.name == 'TelegramAccess' ||
                                data.name == 'WalletAccess' ||
                                data.name == 'TikTokAccess') && (
                                <Box
                                    sx={{
