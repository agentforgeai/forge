...
import { streamStorageFile } from 'AgentForge-components'
...
const getFileFromAssistant = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        if (!fileStream) throw new InternalAgentForgeError(StatusCodes.INTERNAL_SERVER_ERROR, `Error: getFileFromAssistant`)
