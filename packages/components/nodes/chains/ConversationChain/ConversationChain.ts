...
// import { ChatOpenAI } from '../../chatmodels/ChatOpenAI/AgentForgeChatOpenAI'
import {
    IVisionChatModal,
    AgentForgeMemory,
    ICommonObject,
        ...
        this.inputs = [
            {
                ...
                type: 'string',
                rows:2,
                description: 'Write lore about your agent. Separate by , s '
            }
        ]
...
const prepareChatPrompt = (nodeData: INodeData, humanImageMessages: MessageContentImageUrl[]) => {
    const memory = nodeData.inputs?.memory as AgentForgeMemory
