...
class ExtendedLunaryHandler extends LunaryHandler {
    ...
    constructor({ AgentForgeOptions, ...options }: any) {
        super(options)
        this.appDataSource = AgentForgeOptions.appDataSource
        this.databaseEntities = AgentForgeOptions.databaseEntities
        this.chatId = AgentForgeOptions.chatId
        this.apiMessageId = AgentForgeOptions.apiMessageId
    }
