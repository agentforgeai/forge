...
export const AgentForge_CHATID = 'AgentForge_chatId'

/*
 * List of dependencies allowed to be import in @AgentForgeai/nodevm
 */
...
const jsonEscapeCharacters = [
    { escape: '"', value: 'AgentForge_DOUBLE_QUOTE' },
    { escape: '\n', value: 'AgentForge_NEWLINE' },
    { escape: '\b', value: 'AgentForge_BACKSPACE' },
    { escape: '\f', value: 'AgentForge_FORM_FEED' },
    { escape: '\r', value: 'AgentForge_CARRIAGE_RETURN' },
    { escape: '\t', value: 'AgentForge_TAB' },
    { escape: '\\', value: 'AgentForge_BACKSLASH' }
]
